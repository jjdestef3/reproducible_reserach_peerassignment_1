...
ggplot(avgSteps, aes(interval, mean)) + geom_line(color = "blue", size = 0.7) + labs(title = "Time Series Plot of the 5-minute Interval by Steps Taken", x = "5-minute intervals", y = "Average Steps Taken")
```
...
# graph
ggplot(meanNewStepData, aes(interval, steps)) + 
    geom_line() + 
    facet_grid(day ~ .) +
